...
QT_MOC_LITERAL(1, 8, 13), // "label_clicked"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4) // "flag"

    },
    "mylabel\0label_clicked\0\0flag"
};
...
void mylabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (mylabel::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mylabel::label_clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mylabel::label_clicked(bool _t1)
{
